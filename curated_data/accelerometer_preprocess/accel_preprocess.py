# Rounds numbers in all_accel to 6 decimals places. Also adds NAN to .
import pandas as pd
import glob
import os

try:
    os.remove("C:/Users/armonh/Downloads/feltdata/curated_data/accelerometer_preprocess/all_accel_preprocessed_not_csv.txt")
    os.remove("C:/Users/armonh/Downloads/feltdata/curated_data/all_accel_preprocessed.txt")
except OSError:
    pass

# get list of all csv files
csv_files = glob.glob('C:/Users/armonh/Downloads/feltdata/curated_data/accelerometer_preprocess/*.csv*')
df = pd.DataFrame()
...
with open("C:/Users/armonh/Downloads/feltdata/curated_data/all_accel_preprocessed.txt", 'w') as f:
    df_csv = df.to_csv(header=True, index=False, lineterminator="\n")
    f.write(df_csv)

with open("C:/Users/armonh/Downloads/feltdata/curated_data/accelerometer_preprocess/all_accel_preprocessed_not_csv.txt", 'w') as f:
