...
try:
    os.remove("C:/Users/armonh/Downloads/feltdata/curated_data/shackles_preprocess/all_shackles_preprocessed_not_csv.txt")
    os.remove("C:/Users/armonh/Downloads/feltdata/curated_data/all_shackles_preprocessed.txt")
except OSError:
    pass

# get a list of all txt files.
txt_files = glob.glob('C:/Users/armonh/Downloads/feltdata/curated_data/shackles_preprocess/*.txt*')
df = pd.DataFrame()
...
with open("C:/Users/armonh/Downloads/feltdata/curated_data/all_shackles_preprocessed.txt", 'w') as f:
    df_csv = df.to_csv(header=True, index=False, lineterminator="\n")
    f.write(df_csv)

with open("C:/Users/armonh/Downloads/feltdata/curated_data/shackles_preprocess/all_shackles_preprocessed_not_csv.txt", 'w') as f:
